...
const uint8_t PingExtra0[] = {0x05, 0xFA, 0x04, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0xF3};
/* 对机柜广播、模块1、模块类型1的ping帧 */
const uint8_t PingExtra1[] = {0x05, 0xFA, 0x04, 0x01, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0D, 0xF2};
/* 对机柜1、模块1、模块类型1的ping帧 */
const uint8_t PingExtra2[] = {0x05, 0xFA, 0x04, 0x41, 0x00, 0x08, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4D, 0xB2};

/* 符合协议的回复帧 */
const uint8_t PingReply[] = {0x00, 0xFA, 0x80, 0x41, 0x00, 0x08, 0x00, 0x01, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0xCA, 0x35};
