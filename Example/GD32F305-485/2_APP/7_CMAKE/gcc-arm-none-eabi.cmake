...
# MCU-specific 编译标志
set(TARGET_FLAGS "-mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard  ")    # 设置目标平台的特定编译标志
...
set(CMAKE_C_LINK_FLAGS "${CMAKE_C_LINK_FLAGS} -T \"${CMAKE_SOURCE_DIR}/5_PhysicalChip/Cpu/GNU/GD32F305RET6.ld\"")   # 添加链接脚本
